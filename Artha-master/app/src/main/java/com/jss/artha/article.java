...
public class article extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressDialog bar=new ProgressDialog(article.this);
...
////        launchNextActivity = new Intent(article.this, BottomNavigate1.class).putExtra("selected_category",Fragment_stories.s);
